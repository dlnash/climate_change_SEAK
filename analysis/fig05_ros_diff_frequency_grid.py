"""
Filename:    ros_diff_frequency_grid.py
...
# Plot Function
# ============================================================
def plot_ros_diff_frequency(models, varnames, ssn, option, path_to_data,
    ...
    fname = os.path.join(path_to_data, f"preprocessed/SEAK-WRF/cfsr/trends/snow_cfsr_{ssn}_{option}_ros_frequency_clim.nc")
    ...
    for i, varname in enumerate(varnames):
        ...
        for j, model in enumerate(models[1:], start=3):
            ...
            fname = os.path.join(path_to_data, f"preprocessed/SEAK-WRF/{model}/trends/snow_{model}_{ssn}_{option}_ros_frequency_clim.nc")
    ...
    # Save Figure
    # ============================================================
    outname = f"../figs/ros_{option}/{ssn}/{ssn}_ROS_FREQ_DIFF.png"
...
if __name__ == "__main__":
    ...
    for option in option_lst:
        for ssn in ssn_lst:
            ...
            plot_ros_diff_frequency(models, varnames, ssn, option, path_to_data)
