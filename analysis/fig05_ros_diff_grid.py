...
def plot_ros_diff_grid(models, varnames, path_to_data,
    ...
    fname = os.path.join(path_to_data, f"preprocessed/SEAK-WRF/cfsr/trends/snow_cfsr_ros_clim.nc")
    cfsr_ds = xr.open_dataset(fname)

    cfsr_ds['rain'].attrs['units'] = 'mm day-1'
    cfsr_ds['snow'].attrs['units'] = 'mm day-1'
    ...
    # MAIN LOOP
    # ============================================================
    varname_lbl = ['ROS', 'Rain', 'SWE', 'Snowmelt', 'Intensity']
    ...
    for i, varname in enumerate(varnames):
        ...
        # ----------------------------
        if (varname == 'ros') | (varname == 'snow'):
            levs_clim = np.arange(0, 20, 1)
            cmap_clim = cmo.rain
    ...
    # Save Figure
    # ============================================================
    outname = f"../figs/ROS_MODEL_DIFF_GRID.png"
...
if __name__ == "__main__":
    ...
    varnames = ["ros", "rain", "snow", "delsnowh", "ros_intensity"]
